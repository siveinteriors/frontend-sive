...
const Projects = () => {
  ...
  return (
    <div className="container mx-auto min-h-svh px-4 py-12 z-0">
          ...
          projects.map((project) => (
            ...
            >
              ...
              <div className="card-inner relative w-full h-48 transform-style-preserve-3d transition-transform duration-500">
                {/* Front Side - Image */}
                <div className="card-front absolute inset-0 w-full h-48 bg-gray-100">
                  <img
                ...
                {/* Back Side - Title */}
                <div className="card-back absolute inset-0 w-full h-48 bg-gray-400 flex justify-center items-center text-white text-xl font-semibold transform rotate-y-180">
                  {project.title}
                </div>
              </div>
            </Link>
